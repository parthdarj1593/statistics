...
---------------------------------------------------------------------------------
URL for new transaction: http://localhost:8080/transactions
URL for statistics:http://localhost:8080/statistics
URL for mannual schedule job triggering (job runs every 1 min): http://localhost:8080/transactionclean
